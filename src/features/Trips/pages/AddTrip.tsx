...
// Define the shape of your form to prevent "undefined" errors
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select name="truckId" value={formData.truckId} onChange={handleTruckSelect} className="w-full bg-neutral-950 border border-neutral-800 rounded-2xl px-5 py-3.5 text-xs font-bold text-white outline-none focus:border-indigo-500 appearance-none transition-all">
                                        ...
                                        {availableFleet.map((t: Truck) => (<option key={t._id} value={t._id}>{t.truckNumber}</option>))}
                                    </select>
                    ...
                    <div className="bg-neutral-900 border border-neutral-800 rounded-[32px] p-8 space-y-6 shadow-xl border-t-indigo-500 border-t-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 text-zinc-500">
                                ...
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em]">Freight Pricing</h3>
                            </div>
                        ...
                        <div className="mt-4 p-5 bg-black/40 rounded-2xl border border-white/5 grid grid-cols-2 gap-8">
                            <div className="space-y-1">
                                <span className="text-zinc-500 text-[9px] font-black uppercase tracking-widest">Calculated Freight</span>
                                <p className="text-xl font-black text-white tracking-tighter">₹{calculations.totalFreight.toLocaleString()}</p>
                            </div>
                            <div className="space-y-1">
                                <span className="text-zinc-500 text-[9px] font-black uppercase tracking-widest">Estimated Balance</span>
                                <p className={`text-xl font-black tracking-tighter ${calculations.balance > 0 ? "text-amber-500" : "text-emerald-500"}`}>
                ...
                <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-32">
                    ...
                    <div className="bg-neutral-900 border border-neutral-800 rounded-[32px] p-8 text-center space-y-4 shadow-xl">
                        <div className="flex items-center justify-center gap-2 text-zinc-500">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest">Proof of Delivery (POD)</span>
                        </div>
